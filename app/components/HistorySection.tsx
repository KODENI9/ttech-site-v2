        ...
        <section className="max-w-4xl mx-auto p-4 space-y-6">
            <div className="flex justify-between items-center">
                ...
                {isAdmin && (
                    <button
                        ...
                        onClick={() =>
                            (document.getElementById("add_history_modal") as HTMLDialogElement).showModal()
                        }
                    >
                        ➕ Ajouter
                    </button>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {histories.map((item) => (
                    <div
                        key={item.id}
                        className="card shadow-md bg-white border border-base-200 hover:shadow-xl transition-all"
                    >
                        <div className="card-body">
                            <div className="flex items-center justify-between">
                                ...
                                <span className="badge badge-info text-sm">{item.year}</span>
                            </div>
                                ...
                                <div className="mt-4 flex gap-2">
                                    <button
                                        ...
                                        onClick={() => {
                                            ...
                                            (document.getElementById("edit_history_modal") as HTMLDialogElement).showModal();
                                        }}
                                    >
                                        ✏️ Modifier
                                    </button>
            ...
            {isAdmin && (
                <>
                    ...
                    {historyToEdit && (
                        <EditHistoryModal history={historyToEdit} onUpdated={fetchHistories} />
                    )}
                </>
            )}
        </section>
